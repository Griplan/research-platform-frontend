  ...
  <div class="app-container">
    ...
    <div class="table-container">
      <el-table
        ...
        style="width: 100%"
      >
        <el-table-column prop="member_id" label="会员标识" width="120" />
        <el-table-column prop="user_name" label="全名" />
        <el-table-column prop="user_id" label="成员标识" width="120" />
        <el-table-column prop="access_card_number" label="门禁卡号" />
        <el-table-column prop="biometric_authentication" label="生物特征" />
...
export default {
  ...
  methods: {
    fetchRecordList() {
      this.loading = true;
      getUserPermission(this.pagination)
        .then(res => {
          if (res.status == 1) {
